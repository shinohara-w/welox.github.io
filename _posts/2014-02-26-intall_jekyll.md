...
[root@lx008 ~]# rpm -qa |grep ruby
ruby-libs-1.8.7.352-13.el6.x86_64
ruby-1.8.7.352-13.el6.x86_64



[root@lx008 ~]# git clone https://github.com/rubygems/rubygems.git rubygems
...
[root@lx008 ~]#
[root@lx008 ~]# cd rubygems/


[root@lx008 rubygems]# ruby setup.rb
RubyGems 2.2.2 installed
ERROR:  While executing gem ... (Gem::DocumentError)
    RDoc is not installed: no such file to load -- rdoc/rdoc
[root@lx008 rubygems]# yum install rdoc
...
[root@lx008 tech.basicinc.jp]# gem install jekyll
Building native extensions.  This could take a while...
ERROR:  Error installing jekyll:
        ERROR: Failed to build gem native extension.
...
[root@lx008 tech.basicinc.jp]# easy_install
easy_install      easy_install-2.6
[root@lx008 tech.basicinc.jp]# easy_install Pygments
...
[root@lx008 ~]# mv tech.basicinc.jp tech.welox.jp
[root@lx008 ~]# cd tech.welox.jp/



[root@lx008 ~]# git clone https://github.com/welox/welox.github.io.git
...
httpだとだめだったので、ssh認証を通してpush。今度は成功

編集ファイル

[root@lx008 welox.github.io]# cat .git/config
[core]
